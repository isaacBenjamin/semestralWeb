...
function cambiarTipoUsuario($idUsuario, $tipoUsuario)
{
    ...
    $query = "UPDATE usuarios SET tipo_usuario = '$tipoUsuario' WHERE id = $idUsuario";
...
function obtenerUsuarios()
{
    ...
    $query = "SELECT id, nombre, tipo_usuario FROM usuarios";
...
// Asegúrate de tener una conexión a la base de datos y otras configuraciones necesarias aquí
...
function cambiarDatosUsuario($idUsuario, $nuevoNombre, $nuevaContrasena)
{
    ...
    if ($usuarioActual['id'] == $idUsuario && $usuarioActual['id'] != 1) {
        ...
        if (!empty($nuevaContrasena)) {
            ...
            $query = "UPDATE usuarios SET nombre = '$nuevoNombre', contrasena = '$nuevaContrasena' WHERE id = $idUsuario";
        } else {
